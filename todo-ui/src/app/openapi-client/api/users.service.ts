...
export class UsersService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public usersControllerFindOneByEmail(
        username: string,
        observe?: 'body',
        reportProgress?: boolean,
        options?: {
    ...
    public usersControllerFindOneByEmail(
        ...
        if (username === null || username === undefined) {
            throw new Error(
                'Required parameter username was null or undefined when calling usersControllerFindOneByEmail.',
            );
        }
        ...
        let localVarPath = `/users/username/${this.configuration.encodeParam({ name: 'username', value: username, in: 'path', style: 'simple', explode: false, dataType: 'string', dataFormat: undefined })}`;
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public usersControllerFindOneById(
        id: number,
        observe?: 'body',
        reportProgress?: boolean,
        options?: {
    ...
    public usersControllerFindOneById(
        ...
        if (id === null || id === undefined) {
            throw new Error(
                'Required parameter id was null or undefined when calling usersControllerFindOneById.',
            );
        }
