...
export class TodoService {
    ...
    public todoControllerFindOne(
        ...
        let localVarPath = `/todo/${this.configuration.encodeParam({ name: 'id', value: id, in: 'path', style: 'simple', explode: false, dataType: 'number', dataFormat: undefined })}`;
